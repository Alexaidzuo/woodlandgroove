let project_name = 'woodlandgroove';
...
let config = (function(){
	...
	return {
		...
		/***********************************************************************/
		text_domain: '' || project_name, // Example: 'woodlandgroove' #lowercase, separated by underscore or dash ( _ or - )
		packageName: '' || project_name, // Example: 'woodlandgroove package' #Capitalized
...
exports.default = gulp.series( environment, js_lint, plugins_js, site_js, merge_js, css, watch, files, post_build, browser_sync );
