# LibraFire woodlandgroove Theme
...
#Theme functions
- woodlandgroove_posted_on();
    > Example: Posted on April 11, 2019 by
- woodlandgroove_entry_footer();
    > Example: Posted in Uncategorized Tagged test Leave a comment
- woodlandgroove_post_navigation();
    > Example: 1 2 3 … 11
- woodlandgroove_share_links();
    > Example: fb, tw, ln, pinterest
- woodlandgroove_archive_title();
