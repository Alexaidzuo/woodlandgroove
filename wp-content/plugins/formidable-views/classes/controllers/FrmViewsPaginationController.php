...
class FrmViewsPaginationController {
	...
	public static function load_page() {
		...
		if ( false !== strpos( $view->post_content, '[detaillink]' ) ) {
			...
			if ( $site_url ) {
				...
				FrmViewsAppHelper::force_view_as_post_global( $view );
				add_filter(
					'post_link',
	...
	private static function view_includes_comment_marker_at_top( $view ) {
		...
		return FrmViewsDisplaysHelper::is_table_type( $view ) || FrmViewsDisplaysHelper::is_grid_type( $view ) || FrmViewsDisplaysHelper::is_legacy_table_type( $view->ID );
	}
